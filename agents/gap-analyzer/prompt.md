...
```json
{
  "evidence_search": {
    ...
    "found": [
      {
        "location": "Limecord role",
        "text": "AWS multi-account architecture",
        "years": "2023-present"
      },
      {
        "location": "T-Mobile role",
    ...
    "requirements": [
      {
        ...
        "evidence": "- Limecord (2023-present): Multi-account AWS architecture\n- Agora (2022-2023): AWS infrastructure\n- Supreme Golf (2019-2021): AWS cloud services\n- T-Mobile (2017-2019): AWS implementation\nTotal: 6+ years",
        "confidence": "high",
      ...
      },
      {
        ...
        "evidence": "- ECS Fargate orchestration\n- Docker containerization\n- Container orchestration concepts",
        "confidence": "medium",
        ...
        "framing": "Container orchestration experience with ECS Fargate; familiar with Kubernetes concepts and patterns"
      },
      {
        "id": 3,
        "text": "GCP experience",
        ...
        "framing": "AWS-native with deep multi-cloud architecture understanding; cloud concepts are transferable",
    ...
    "cultural_signals": [
      {
        ...
        "fit": "Compatible with startup experience at Supreme Golf, Agora"
      },
      {
