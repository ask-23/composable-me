...
class TestAuditorSuiteAgent:
    ...
    @patch('runtime.crewai.agents.auditor.AuditorSuiteAgent.execute_with_retry')
    def test_execute_success(self, mock_execute, auditor_suite, sample_context, valid_output):
